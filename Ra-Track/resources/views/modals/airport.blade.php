...
<div id="airport-modal" class="fixed inset-0 z-50 hidden items-center justify-center overflow-y-auto modal-backdrop">
    <div class="bg-slate-700/70 backdrop-blur-sm rounded-lg shadow-xl w-full max-w-lg p-6 mx-4">
        <div class="flex justify-between items-center border-b border-gray-700 pb-3 mb-4">
            <h3 id="airport-modal-title" class="text-lg font-semibold text-yellow-200">Ajouter un Aéroport</h3>
        ...
        <form id="airport-form">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="airport_iata_code" name="code_iata" class="w-full text-white border border-gray-600 rounded px-3 py-2 text-white placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-yellow-200 focus:border-yellow-200" style="background-color:#162238;" placeholder="Ex: CDG" maxlength="3" required>
            </div>

            <div class="mb-4">
                <label for="airport_name" class="block text-sm font-medium text-gray-300 mb-1">Nom de l'aéroport</label>
                <input type="text" id="airport_name" name="name" class="w-full border border-gray-600 rounded px-3 py-2 text-white placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-yellow-200 focus:border-yellow-200" style="background-color:#162238;" placeholder="Ex: Paris Charles de Gaulle" required>
            </div>
            ...
            <div class="mb-4 relative">
                ...
                <input type="text" id="airport_location_autocomplete" name="location" class="w-full  border border-gray-600 rounded px-3 py-2 text-white placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-yellow-200 focus:border-yellow-200" style="background-color:#162238;" placeholder="Commencez à taper (ex: Paris...)" required autocomplete="off">
            ...
            <div class="flex justify-end space-x-3 pt-4 border-t border-gray-700">
                <button type="button" class="close-modal font-bold py-2 px-4 rounded" style="color: #162238; border: 1px solid #FFD476;background: #FFD476;
                ...
                <button type="submit" id="save-airport-button" class="font-bold py-2 px-4 rounded" style="color: #162238; border: 1px solid #FFD476;background: #FFD476;
                                    box-shadow: -5px -5px 15px rgba(255, 255, 255, 0.1),
                                    5px 5px 15px rgba(0, 0, 0, 0.35),
                                    inset -5px -5px 15px rgba(255, 255, 255, 0.1),
                                    inset 5px 5px 15px rgba(0, 0, 0, 0.35);">
                        ...
                        airports.forEach(function(airport) {
                            ...
                            <tr class="border-b border-gray-700">
                                ...
                                <td class="py-4 px-6 flex space-x-2">
                                    ...
                                    <button class="edit-airport-button text-gray-900 hover:text-yellow-200" title="Modifier" data-id="${airport.id}">
                                    ...
                                    <button class="delete-airport-button text-gray-900 hover:text-yellow-200" title="Supprimer" data-id="${airport.id}">
                                         <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
