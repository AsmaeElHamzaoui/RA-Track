...
<div id="aircraft-content" class="content-section hidden">
    <section class="bg-slate-900/70 backdrop-blur-sm p-4 rounded-lg shadow-md">
        <div class="flex justify-between items-center mb-6">
            ...
            <button id="open-add-aircraft-modal" class="font-bold py-2 px-4 rounded inline-flex items-center" style="color: #162238; border: 1px solid #FFD476;background: #FFD476;
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left">
                <thead class="text-xs text-gray-400 uppercase border-b border-gray-700">
                    <tr>
                        <th scope="col" class="px-4 py-3" style="color:#FFD476;" >Immatriculation</th>
                        <th scope="col" class="px-4 py-3" style="color:#FFD476;" >Modèle</th>
                        <th scope="col" class="px-4 py-3" style="color:#FFD476;" >Compagnie</th>
