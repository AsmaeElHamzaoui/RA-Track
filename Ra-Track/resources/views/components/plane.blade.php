                ...
                <tbody>
                    @foreach($planes as $plane)
                        <tr class="border-b border-gray-700 hover:bg-gray-700">
                            ...
                            <td class="px-4 py-3">{{ $plane->company }}</td>
                            <td class="px-4 py-3">
                                <span class="px-2 py-1 text-xs font-medium rounded-full {{ $plane->status == 'Actif' ? 'bg-green-600 text-green-100' : 'bg-yellow-600 text-yellow-100' }}">
                                    {{ $plane->status }}
                                </span>
                            </td>
