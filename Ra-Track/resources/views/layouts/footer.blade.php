<footer class="text-gray-300 py-4 md:py-6" style="border-radius:20px 20px 0 0; background-color:#162238;">
    <div class="container mx-auto px-4">
        ...
        <div class="flex flex-col md:flex-row items-center justify-between mx-2 md:mx-4 lg:mx-8 mb-2 md:mb-2 space-y-6 md:space-y-0">
            <a href="/">
                <img src="{{ asset('images/logo.png') }}" alt="LimoWide Logo" class="h-6 md:h-8">
            </a>
            <div class="flex space-x-4">
                <a href="#" class="hover:text-white" style="color:#FFD476"><i class="fab fa-linkedin-in text-l"></i></a>
                <a href="#" class="hover:text-white" style="color:#FFD476"><i class="fab fa-twitter text-l"></i></a>
                <a href="#" class="hover:text-white" style="color:#FFD476"><i class="fab fa-facebook-f text-l"></i></a>
                <a href="#" class="hover:text-white" style="color:#FFD476"><i class="fab fa-pinterest text-l"></i></a>
                <a href="#" class="hover:text-white" style="color:#FFD476"><i class="fab fa-whatsapp text-l"></i></a>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 mx-20 md:grid-cols-2 lg:grid-cols-6  gap-4 md:gap-6 lg:gap-8 mb-2 md:mb-10 px-4 md:px-0">
            ...
            <div class="hidden lg:block text-center md:text-left">
                <h4 class="font-smal mb-3 text-base" style="color:#FFD476;">COMPANY</h4>
                <ul class="space-y-2">
            ...
            <div class="hidden md:block text-center md:text-left">
                <h4 class="font-smal mb-3 text-base" style="color:#FFD476;">SERVICES</h4>
                <ul class="space-y-2">
            ...
            <div class="block text-center md:text-left"> <!-- 'block' est implicite mais peut être mis pour la clarté -->
                <h4 class="font-smal mb-3 text-base" style="color:#FFD476;">CONTACT</h4>
                <ul class="space-y-2">
            ...
            <div class="hidden lg:block text-center md:text-left">
                <h4 class="font-smal mb-3 text-base" style="color:#FFD476;">PARTNERSHIP</h4>
                <ul class="space-y-2">
            ...
            <div class="hidden lg:block text-center md:text-left">
                <h4 class="font-smal mb-3 text-base" style="color:#FFD476;">LEGAL</h4>
                <ul class="space-y-2">
            ...
            <div class="hidden lg:block text-center md:text-left">
                <h4 class="font-smal mb-3 text-base" style="color:#FFD476;">HELP</h4>
                <ul class="space-y-2">
        ...
        <div class="flex flex-col md:flex-row items-center justify-between mx-4 mt-6 border-t border-gray-700 pt-4 space-y-4 md:space-y-0">
            ...
            <div class="flex items-center space-x-3">
                ...
                <img class="h-3 w-auto" src="{{ asset('images/logo.png') }}" alt="American Express">
            </div>
        </div>
    </div>
</footer>